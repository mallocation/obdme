...
public class BasicUserModePortrait {
	 ...
	 * @return the view
	 */
	private View buildEnabledView(Context context, OBDPID upperPID, OBDPID lowerPID, Integer currentView) {
		...
		rootLinearLayout.addView(buildValueView(context, upperPID, currentView));
		...
		rootLinearLayout.addView(buildValueView(context, lowerPID, currentView));
	...
	private View buildEnabledView(Context context, OBDPID singlePID, Integer currentView) {
		...
		rootLinearLayout.addView(buildValueView(context, singlePID, currentView));
