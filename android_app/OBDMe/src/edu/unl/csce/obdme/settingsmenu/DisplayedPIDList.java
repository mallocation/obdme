 ...
 */
public class DisplayedPIDList extends Activity {
	...
	/** The collected pid list. */
	private HashMap<String, List<String>> collectedPIDList;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.collectedPIDList = elmFramework.getObdFramework().getCollectedPIDList();
	...
	private ArrayAdapter<String> buildListAdapter() {
		...
		for (String currentMode : this.collectedPIDList.keySet()) {
			for ( String str : this.collectedPIDList.get(currentMode)) {
