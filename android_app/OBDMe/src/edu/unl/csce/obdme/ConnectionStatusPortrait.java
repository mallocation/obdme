...
/**
 * The Class ConnectionStatusPortrait.
 */
public class ConnectionStatusPortrait {
	...
	/**
	 * Instantiates a new connection status portrait.
	 *
	 * @param context the context
	 */
	public ConnectionStatusPortrait(Context context) {
	...
	private void buildInitialView() {
		...
		rootLinearLayout.setBackgroundDrawable(context.getResources().getDrawable(R.drawable.background_portrait));
	...
	private LinearLayout buildPhoneIcon(){
		...
		phoneLinearLayout.setOrientation(LinearLayout.VERTICAL);
	...
	private FrameLayout buildConnectingIcon(){
		...
		this.wirelessFialedImage.setImageDrawable(context.getApplicationContext().getResources().getDrawable(R.drawable.wireless_connect_fail_portrait));
		...
		wireless1Image.setImageDrawable(context.getApplicationContext().getResources().getDrawable(R.drawable.wireless_connecting_portrait_1));
		...
		wireless2Image.setImageDrawable(context.getApplicationContext().getResources().getDrawable(R.drawable.wireless_connecting_portrait_2));
		...
		wireless3Image.setImageDrawable(context.getApplicationContext().getResources().getDrawable(R.drawable.wireless_connecting_portrait_3));
